...
public class JobList {
     ...
     */
    @JsonProperty("items")
    @JsonPropertyDescription("items is the list of Jobs.")
    ...
    public String toString() {
        ...
        sb.append(JobList.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof JobList) == false) {
            return false;
        }
        JobList rhs = ((JobList) other);
