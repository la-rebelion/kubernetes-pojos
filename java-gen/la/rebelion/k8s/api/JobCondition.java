...
public class JobCondition {
     ...
     */
    @JsonProperty("reason")
    @JsonPropertyDescription("(brief) reason for the condition's last transition.")
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("Type of job condition, Complete or Failed.")
    private String type;
     ...
     * @param source
     */
    public JobCondition(JobCondition source) {
        super();
     ...
     * @param status
     */
    public JobCondition(Date lastProbeTime, Date lastTransitionTime, String message, String reason, String status, String type) {
        super();
    ...
    public String toString() {
        ...
        sb.append(JobCondition.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof JobCondition) == false) {
            return false;
        }
        JobCondition rhs = ((JobCondition) other);
